package com.example.appchatrealtime.login;
...
import com.example.appchatrealtime.register.RegisterFragment;
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        loginViewModel.isShowMessage.observe(getActivity(), new Observer<Boolean>() {
            ...
            public void onChanged(Boolean aBoolean) {
                if(!aBoolean){
                    getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.frame, BottomFragment.newInstance()).commit();
